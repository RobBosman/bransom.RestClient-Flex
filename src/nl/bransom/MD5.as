...
package nl.bransom {
	...
	public class MD5 {
		...
		private function RotateLeft(lValue:int, iShiftBits:int):int {
			return (lValue<<iShiftBits) | (lValue>>>(32-iShiftBits));
		}
		
		private function AddUnsigned(lX:int,lY:int):int {
		...
		private function F(x:int,y:int,z:int):int { return (x & y) | ((~x) & z); }
		private function G(x:int,y:int,z:int):int { return (x & z) | (y & (~z)); }
		private function H(x:int,y:int,z:int):int { return (x ^ y ^ z); }
		private function I(x:int,y:int,z:int):int { return (y ^ (x | (~z))); }
		
		private function FF(a:int,b:int,c:int,d:int,x:int,s:int,ac:int):int {
			a = AddUnsigned(a, AddUnsigned(AddUnsigned(F(b, c, d), x), ac));
			return AddUnsigned(RotateLeft(a, s), b);
		}
		
		private function GG(a:int,b:int,c:int,d:int,x:int,s:int,ac:int):int {
			a = AddUnsigned(a, AddUnsigned(AddUnsigned(G(b, c, d), x), ac));
			return AddUnsigned(RotateLeft(a, s), b);
		}
		
		private function HH(a:int,b:int,c:int,d:int,x:int,s:int,ac:int):int {
			a = AddUnsigned(a, AddUnsigned(AddUnsigned(H(b, c, d), x), ac));
			return AddUnsigned(RotateLeft(a, s), b);
		}
		
		private function II(a:int,b:int,c:int,d:int,x:int,s:int,ac:int):int {
			a = AddUnsigned(a, AddUnsigned(AddUnsigned(I(b, c, d), x), ac));
			return AddUnsigned(RotateLeft(a, s), b);
		}
		
		private function ConvertToWordArray(string:String):Array {
			var lWordCount:int;
		...
		private function WordToHex(lValue:int): String {
